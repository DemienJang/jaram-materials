...
좋은 내용을 준비하는 것과 그 내용을 학생에게 잘 전달하는 것은 다르다. 진로반 수업 뒤, 교사는 아이들의 반응을 기다리고 수업을 조정하는 일이 자신의 다음 과제임을 깨닫는다.

## 이미지 콘셉트

소그룹 모임이 끝난 뒤 소그룹실에 남은 남자 리더가 빈 의자와 펼쳐진 수업 자료를 바라보는 장면. 학교 교실이 아닌 교회·공동체의 작은 모임 공간에서, 실패를 과장하지 않고 아쉬움과 다시 해보고 싶은 마음이 함께 남는 조용한 성찰의 순간을 표현한다.

## 구도와 분위기

- 정사각형 기본 구도
- 4:1 가로 크롭에서도 교사와 펼쳐진 노트가 중앙에 남도록 구성
- 늦은 오후의 부드러운 자연광
...
- `output/title-image/title-deliberate-practice.png`
